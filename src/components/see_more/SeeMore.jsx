...
function SeeMore() {
  return (
    <>
      <section id="see-more" className="mt-2 text-white rounded-3xl bg-gradient-to-r from-[#8044E2] to-[#E2446A] hover:bg-gradient-to-l from-[#E2446A] to-[#8044E2] transition-all p-[3px]">
