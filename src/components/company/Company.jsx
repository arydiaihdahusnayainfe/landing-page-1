...
function Company() {
  return (
    <>
      ...
      <section
        id="company"
        className="bg-section mt-2 py-8 px-6 rounded-3xl text-white w-full overflow-x-scroll scrollbar-hide cursor-grab">
        <div className="flex gap-4 w-[450px] md:w-[800px] mx-auto">
          {/* Company logo */}
